CLASS zcl_scope_page_space_908 DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
...
CLASS zcl_scope_page_space_908 IMPLEMENTATION.
...
* Page template
    ( object = if_aps_bc_scope_change_api=>gc_tadir_object-uipg obj_name = 'ZRAP100_TRAVEL_908' )
    )
